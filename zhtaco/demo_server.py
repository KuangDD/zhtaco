...
if __name__ == '__main__':
    ...
    cp_path = r'E:\data\logs\logs-biaobei-blank\model.ckpt-20000'
    parser.add_argument('--checkpoint', default=cp_path, help='Full path to model checkpoint')
    parser.add_argument('--port', type=int, default=9000)
    hp_path = os.path.join(os.path.join(os.path.dirname(cp_path), 'hparams.json'))
